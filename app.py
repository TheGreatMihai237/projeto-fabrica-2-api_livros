# instalamos a biblioteca flask no terminal
# Importamos a biblioteca para o nosso arquivo
...
# instanciamos o flask(criar um objeto a partir de uma classe)
# Uma instância é o objeto real construído a partir desse molde
app = Flask(__name__)
